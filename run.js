...
if (Config.ALIVEMSG == 'default') MSG = `\n\n*🖲️ᴀʟᴘʜᴀ ᴍᴜʟᴛɪ-ᴅᴇᴠɪᴄᴇ ʙᴏᴛ🖲️*\n*ʜᴇʏ ᴛʜᴇʀᴇ ɪ'ᴍ ᴏɴʟɪɴᴇ ɴᴏᴡ*\n\n*◉ᴠᴇʀꜱɪᴏɴ :► 1.5.1 (ᴘʀɪᴠᴀᴛᴇ ʀᴇᴀʟɪꜱᴇ)*\n*◉ᴀʙᴏᴜᴛ :► ᴀʟᴘʜᴀ ʙᴏᴛ ɪꜱ ꜱʀɪ ʟᴀɴᴋᴀɴ ʙᴇꜱᴛ ᴍᴜʟᴛɪ-ᴅᴇᴠɪᴄᴇ ᴡʜᴀᴛꜱᴀᴘᴘ ᴜꜱᴇʀ ʙᴏᴛ*\n*◉ᴅᴇᴠᴇʟᴏᴘᴇʀ  :► ᴍʀ.ᴛɪᴍᴀ*\n\nᴛʜᴀɴᴋꜱ ꜰᴏʀ ᴜꜱɪɴɢ ᴀʟᴘʜᴀ ᴍᴜʟᴛɪ-ᴅᴇᴠɪᴄᴇ ʙᴏᴛ💞\n\n©ᴀʟᴘʜᴀ ᴍᴜʟᴛɪ-ᴅᴇᴠɪᴄᴇ ʙᴏᴛ`
                ...
                XeonBotInc.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/8e40c1953aae06eb8960e.jpg' }, caption: MSG }, { quoted: m })
    }
            break
            case 'github': case 'script': {
                reply(`GitHub : https://github.com/ABLKSTUDIO`)
            }
            break
            case 'update': {
                XeonBotInc.sendMessage(from, { text: `*👨‍💻ᴠᴇʀꜱɪᴏɴ = 1.0.0*\n*ɴᴇᴡ ᴜᴘᴅᴀᴛᴇ ᴄᴏᴍɪɴɢ ꜱᴏᴏɴ*\n*ᴊᴏɪɴ ᴀʟᴘʜᴀ ᴏꜰꜰɪᴄɪᴀʟ ꜱᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ*` }, { quoted: m})
        }
            break
            case 'dyno': case 'clear': case 'mediafire': case 'fb': case 'tiktok': case 'panel': case 'mute': case 'up': {
